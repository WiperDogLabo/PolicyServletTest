...
// var data = cols.findOne({jobName: 'MySQL.Database_Area.JobTest01'});
...
if(dataAll.size() == 1) {
	print('Inserted only one record to policy_message corresponding to jobName:\'MySQL.Database_Area.JobTest01\' and instance:\'inst1-@MYSQL-information_schema\'!!!')
} else {
